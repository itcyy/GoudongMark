...
export default {
  data () {
    return {
      footerNavs: [
        {value: '狗东商城', url: '/'},
        { value: 'HarmonyOS', url: 'https://www.HarmonyOS.com/'},
      
        {value: '游戏', url: 'http://game.xiaomi.com/'},
        {value: '路由器', url: 'http://www.miwifi.com/'},
        {value: '会员卡', url: 'https://www.mi.com/micard/'},
        {value: '政企服务', url: 'https://b.mi.com/?client_id=180100031058&masid=17409.0358'},
        {value: '狗东天猫店', url: 'https://xiaomi.tmall.com/'},
        {value: '狗东集团隐私政策', url: 'https://privacy.mi.com/all/zh_CN/'},
        {value: '狗东商城隐私政策', url: 'https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/ded8d0e4a77d.html'},
        {value: '狗东商城用户协议', url: 'https://www.mi.com/about/user-agreement/'},
